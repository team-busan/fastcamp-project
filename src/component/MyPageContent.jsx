...
export default function MyPageContent({list, setList}) {
  ...
  return (
    <div className="flex bg-zinc-100 w-full flex-col  items-stretch px-20 py-12 ">
      <div className="flex flex-col bg-white items-stretch">
          ...
          <div className='block bg-white mx-10 my-12 md:flex flex-wrap'>
            {list.map((item, index) => {
                return(
                  
                  <div key={index} className='flex-col items-center w-full md:w-3/12  pt-10 mb-10 pl-6 pr-6 object-center'>
