      ...
      <div className="flex grow basis-[0%] flex-col items-stretch pb-12 rounded-[50px]">
        ...
        <div className="flex md:hidden relative flex-col overflow-hidden self-stretch min-h-[355px] items-stretch bg-white rounded-[0px_0px_40px_40px]">
          <div className="absolute flex flex-col w-full h-full">
            <img src={article.image} className="h-full w-full object-cover object-center" />
          </div>
          ...
          <div className="justify-center text-white text-lg leading-6 relative mt-8 ml-10 mr-10">
            <a href={article.link} target="_blank" rel="noreferrer">{article.content.length > 60 ? article.content.slice(0, 60) + "..." : article.content}</a>
          </div>
        </div>
